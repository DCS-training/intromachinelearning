...
Hello Everyone! This is the Readme File for the Intro to Machine Learning in Python course (delivered by the CDCS in 2023 and 2024).

This course is aimed at providing an introduction to machine learning for those with some beginner level python skills.
